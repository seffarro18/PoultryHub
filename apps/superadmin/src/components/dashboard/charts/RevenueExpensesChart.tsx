...
import { axisTick, gridProps, legendWrapperStyle, tooltipContentStyle, tooltipItemStyle, tooltipLabelStyle } from "@poultryhub/shared/components/dashboard/charts/chartTheme";

const currencyFormatter = (v: number) => `₱${(v / 1000).toFixed(0)}K`;

export default function RevenueExpensesChart({ data }: { data: RevenueExpensePoint[] }) {
  return (
