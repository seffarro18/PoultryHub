...
import { getFeedConsumption } from "../../../services/farmDashboardService";
import { axisTick, gridProps, tooltipContentStyle, tooltipItemStyle, tooltipLabelStyle } from "./chartTheme";

export default function FarmFeedConsumptionChart() {
  const data = getFeedConsumption();
    ...
    <ChartCard title="Feed Consumption" subtitle="This week, in kg">
      <ResponsiveContainer width="100%" height="100%">
        <BarChart data={data} margin={{ top: 8, right: 8, bottom: 0, left: -12 }}>
          ...
          />
          <Bar dataKey="value" fill="var(--chart-series-3)" radius={[4, 4, 0, 0]} maxBarSize={28} />
        </BarChart>
      </ResponsiveContainer>
    </ChartCard>
  );
