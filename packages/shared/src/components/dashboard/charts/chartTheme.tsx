...
/** Spread onto a chart's primary Area/Bar/Line — draws in once on first load within the 500–1000ms "calm agricultural tech" range, instead of Recharts' 1500ms default. */
