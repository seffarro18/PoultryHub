...
import { getChickenPopulation } from "../../../services/farmDashboardService";
...
export default function FarmChickenPopulationChart() {
  const data = getChickenPopulation();
  const total = data.reduce((sum, d) => sum + d.value, 0);

  return (
    <ChartCard title="Chicken Population" subtitle={`${total.toLocaleString()} birds by type`}>
